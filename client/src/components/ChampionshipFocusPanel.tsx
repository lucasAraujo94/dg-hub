...
export function ChampionshipFocusPanel({
  ...
  return (
    <div className="rounded-[28px] border border-white/8 bg-[#152231] px-4 py-4 shadow-[0_18px_50px_-40px_rgba(0,0,0,0.45)] print:rounded-none print:border-black/20 print:bg-none print:shadow-none">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded-full border border-white/8 bg-[#1a2838] px-2.5 py-1 text-[10px] uppercase tracking-[0.22em] text-muted-foreground">
              {campeonato.fase}
            </span>
          </div>
          <div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          <div className="rounded-2xl border border-white/8 bg-[#1a2838] px-3 py-3">
          ...
          <div className="col-span-2 rounded-2xl border border-white/8 bg-[#1a2838] px-3 py-3 sm:col-span-1">
