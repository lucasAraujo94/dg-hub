...
export default function HomeAdminPollsPanel({
  ...
  return (
    <>
      <div className="card-elegant space-y-4 border border-cyan-400/30 bg-black/40 p-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <input
              className="w-full rounded-md border border-cyan-400/40 bg-black/30 px-3 py-2 text-sm text-white"
              value={pollPergunta}
        ...
        <div>
          ...
          <textarea
            className="min-h-[120px] w-full rounded-md border border-cyan-400/40 bg-black/30 px-3 py-2 text-sm text-white"
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            {pollResults.map(poll => (
              <Card key={poll.pollId} className="border border-cyan-500/30 bg-black/30 p-4">
                <div className="flex items-center justify-between">
                  <div>
